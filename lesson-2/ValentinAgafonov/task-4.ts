...
function revertLettersInAllWords(inputSting: string): string {
...
function revertLettersInWord(inputSting: string): string {

    let inputArray: string[] = inputSting.split(''),
        i: number = 0,
        j: number = inputArray.length - 1,
        tmp: string;
